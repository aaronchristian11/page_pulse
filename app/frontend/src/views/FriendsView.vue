    ...
    <div class="flex flex-col gap-6 p-6 max-w-2xl mx-auto">
        ...
        <div class="flex flex-col gap-2">
            ...
            >
                ...
                <Button
                    v-if="!followsStore.isFollowing(searchResult.id)"
                    label="Follow"
            ...
            <TabPanels>
                ...
                <TabPanel value="following">
                    ...
                    <div v-else class="flex flex-col gap-2 mt-3">
                        <div
                            v-for="user in followsStore.following"
                            :key="user.id"
                            class="flex items-center justify-between bg-surface-50 dark:bg-surface-800 rounded-lg px-4 py-3"
                        >
                            <div>
                ...
                <TabPanel value="followers">
                    ...
                    <div v-else class="flex flex-col gap-2 mt-3">
                        <div
                            v-for="user in followsStore.followers"
                            :key="user.id"
                            class="flex items-center justify-between bg-surface-50 dark:bg-surface-800 rounded-lg px-4 py-3"
                        >
                            <div>
                            ...
                            <Button
                                v-if="!followsStore.isFollowing(user.id)"
                                label="Follow back"
                                icon="pi pi-user-plus"
                                size="small"
                ...
                <TabPanel value="recs">
                    <div
                        v-if="!followsStore.friendRecommendations.length"
                    ...
                    <div v-else class="flex flex-col gap-3 mt-3">
                        <div
                            v-for="rec in followsStore.friendRecommendations"
                        ...
                        >
                            <div class="flex-1 min-w-0">
                                <a
                                    :href="`https://openlibrary.org/works/${rec.key}`"
                                    target="_blank"
                            ...
                            <Button
                                v-if="!booksStore.isOnShelf(rec.key)"
                                icon="pi pi-plus"
                                label="Add"
                                size="small"
